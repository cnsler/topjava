...
public class MealRestController {
    ...
    public List<MealTo> getAll() {
        log.info("getAll");
        return MealsUtil.getTos(service.getAll(SecurityUtil.getAuthUserId()), SecurityUtil.getAuthUserCaloriesPerDay());
    }

    public List<MealTo> getFiltered(LocalDate dateFrom, LocalDate dateTo, LocalTime timeFrom, LocalTime timeTo) {
        log.info("getFiltered");
        return MealsUtil.getFilteredTos(service.getFiltered(SecurityUtil.getAuthUserId(),
                dateFrom, dateTo), SecurityUtil.getAuthUserCaloriesPerDay(), timeFrom, timeTo);
    }
