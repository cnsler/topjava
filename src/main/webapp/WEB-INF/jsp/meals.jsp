...
<div class="jumbotron pt-4">
    <div class="container">
        ...
        <form id="filterForm">
            ...
            <button type="reset" onclick="updateTable()"><spring:message code="meal.reset"/></button>
            <button type="button" onclick="filterTable()"><spring:message code="meal.filter"/></button>
        </form>
        <hr>
