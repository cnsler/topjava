...
public class MealTestData {
    ...
    public static final List<MealTo> MEALS_TO_BETWEEN = List.of(createTo(meal5, true), createTo(meal1, false));
    public static final List<MealTo> MEALS_TO_BETWEEN_WITH_NULL = List.of(createTo(meal5, true), createTo(meal4, true), createTo(meal1, false));
