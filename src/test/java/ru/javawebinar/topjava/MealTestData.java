...
public class MealTestData {
    ...
    public static final List<MealTo> mealsToBetween = List.of(createTo(meal5, true), createTo(meal1, false));
    public static final List<MealTo> mealsToBetweenWithNull = List.of(createTo(meal5, true), createTo(meal4, true), createTo(meal1, false));
