...
public class MealTestData {
    ...
    public static final int ADMIN_MEAL_ID1 = START_SEQ + 10;
    public static final int NOT_FOUND = 10;

    public static final Meal userMeal1 = new Meal(USER_MEAL_ID1,
            LocalDateTime.of(2021, Month.JANUARY, 31, 0, 0),
            "USER coffee", 50);
    public static final Meal userMeal2 = new Meal(USER_MEAL_ID1 + 1,
            LocalDateTime.of(2021, Month.JANUARY, 30, 10, 0),
            "USER breakfast", 700);
    public static final Meal userMeal3 = new Meal(USER_MEAL_ID1 + 2,
            LocalDateTime.of(2021, Month.JANUARY, 30, 13, 0),
            "USER launch", 1000);
    public static final Meal userMeal4 = new Meal(USER_MEAL_ID1 + 3,
            LocalDateTime.of(2021, Month.JANUARY, 30, 18, 0),
            "USER dinner", 300);
    public static final Meal userMeal5 = new Meal(USER_MEAL_ID1 + 4,
            LocalDateTime.of(2021, Month.JANUARY, 31, 10, 0),
            "USER breakfast", 700);
    public static final Meal userMeal6 = new Meal(USER_MEAL_ID1 + 5,
            LocalDateTime.of(2021, Month.JANUARY, 31, 13, 0),
            "USER launch", 1000);
    public static final Meal userMeal7 = new Meal(USER_MEAL_ID1 + 6,
    ...
    public static final Meal adminMeal1 = new Meal(ADMIN_MEAL_ID1,
            ...
            "ADMIN breakfast", 700);
    public static final Meal adminMeal2 = new Meal(ADMIN_MEAL_ID1 + 1,
